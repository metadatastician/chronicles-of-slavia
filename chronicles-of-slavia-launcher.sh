...
# @a2ml-metadata begin
# (
#   id                   = "chronicles-of-slavia-launcher"
#   type                 = "launcher"
#   version              = "0.1.0"
#   app-name             = "chronicles-of-slavia"
#   app-display          = "Chronicles of Slavia"
#   app-url              = ""
...
#
# ============================================================================
# chronicles-of-slavia-launcher.sh — Chronicles of Slavia
# ============================================================================
# GENERATED by launch-scaffolder from chronicles-of-slavia.launcher.a2ml.
...
APP_NAME="chronicles-of-slavia"
APP_DISPLAY="Chronicles of Slavia"
APP_DESC="Prototype game"
APP_CATEGORIES="Game;"
APP_GENERIC_NAME="Chronicles of Slavia"
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/chronicles-of-slavia/chronicles-of-slavia.launcher.a2ml"

URL=""


PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/chronicles-of-slavia.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/chronicles-of-slavia/game.log"

# Search list from [runtime].startup-command-search — first executable wins.
START_COMMAND=""
for candidate in \
    "/engine/target/release/slavia-zone-a" \
    "/engine/slavia-zone-a/target/release/slavia-zone-a" \
    "slavia-zone-a" \
    ; do
    if [ -x "$candidate" ]; then
...
[runtime].startup-command-search or [runtime].command in chronicles-of-slavia.launcher.a2ml."
            return 1
        fi
    fi
