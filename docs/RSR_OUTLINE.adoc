...
image:https://img.shields.io/badge/Code-AGPL--3.0--or--later-blue.svg[Code licence: AGPL-3.0-or-later,link="https://www.gnu.org/licenses/agpl-3.0"] image:https://img.shields.io/badge/Docs-CC--BY--SA--4.0-blue.svg[Docs licence: CC-BY-SA-4.0,link="https://creativecommons.org/licenses/by-sa/4.0/"]
:toc:
:sectnums:
...
|`LICENSE`
|AGPL-3.0-or-later (code) / CC-BY-SA-4.0 (docs)

|`EXHIBIT-A-ETHICAL-USE.txt`
|ethical-use notice (LICENSE Exhibit A)
...
├── EXHIBIT-A-ETHICAL-USE.txt  # ethical-use notice
